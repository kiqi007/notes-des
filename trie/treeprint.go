// Package trie provides a simple ASCII tree composing tool.
// copy from github.com/xlab/treeprint
package trie

// @Des: 树状结构构建与输出，为原实现扩展了压缩单叉节点的功能
// @Des: copy from github.com/xlab/treeprint
...
func (n *node) Tidy(seq Value) Tree {
	if len(n.Nodes) == 1 { // 如果node数为1，则需压缩
		n.Value = n.Value + seq + n.Nodes[0].Value
